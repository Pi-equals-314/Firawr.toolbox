...
def organize_directory(directory_path):
    categories = {
        "Music": (
            ".mp3", ".wav", ".flac", ".m4a", ".aac", ".ogg", ".oga", ".wma", ".mid",
        ),
        "Videos": (
            ".mp4", ".avi", ".mkv", ".mpeg", ".wmv", ".vob", ".flv", ".mov", ".3gp", ".webm",
        ),
        "Source Files": (
            ".py", ".c", ".cpp", ".java", ".js", ".cs", ".html", ".css", ".php",
            ".json", ".xml", ".sql", ".db",
        ),
        "Executables": (
            ".exe", ".msi", ".sh", ".bat", ".apk", ".jar", ".deb", ".run",
            ".bin", ".dmg", ".iso",
        ),
        "Pictures": (
        ...
        "Documents": (
            ...
            ".txt", ".md", ".odt", ".ods", ".odp", ".csv", ".rtf",
        ),
        "Compressed": (
            ".zip", ".rar", ".tar", ".gz", ".7z", ".bz2", ".xz", ".z", ".lz",
        ),
        "Torrents": (".torrent",),
    }
